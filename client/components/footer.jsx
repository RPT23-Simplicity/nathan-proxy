            ...
            <div className="footer">
                <ul className="footer-content">
                    <ul className="list1">
                        ...
                        <li className="footer-text">PROMOTIONS</li>
                        <li className="footer-text">FIND A STORE</li>
                        <li className="footer-text">SIGN UP FOR EMAIL</li>
                        <li className="footer-text">BECOME A MEMBER</li>
                        <li className="footer-text">NIKE JOURNAL</li>
                        <li className="footer-text">SEND US FEEDBACK</li>
                    </ul>
                    <ul className="list2">
                        <li className="footer-text">GET HELP</li>
                        <li className="footer-text subtext">Order Status</li>
                        <li className="footer-text subtext">Shipping and Delivery</li>
                        <li className="footer-text subtext">Returns</li>
                        <li className="footer-text subtext">Payment Options</li>
                        <li className="footer-text subtext">Gift Card Balance</li>
                        <li className="footer-text subtext">Contact Us</li>
                    </ul>
                    <ul className="list3">
                        <li className="footer-text">ABOUT NIKE</li>
                        <li className="footer-text subtext">News</li>
                        <li className="footer-text subtext">Careers</li>
                        <li className="footer-text subtext">Investors</li>
                        <li className="footer-text subtext">Purpose</li>
                        <li className="footer-text subtext">Sustainability</li>
                        <li className="footer-text subtext">CA Supply Chains Act</li>
                    </ul>
